...
export default function ProfileCard({}: Props) {
  return (
    <section className='flex flex-col  '>
      <ProjectDescription title={'Profile Card'} stack={'Html, CSS'} />

      <div className='w-[340px] flex flex-col items-center gap-10 bg-white rounded-lg py-6 px-4 '>
        <article className='profile-card_author flex flex-col items-center gap-6'>
          <article className='relative w-16 h-16 rounded-full '>
            <Image
              src='/imgs/marketing/profilecard/profile.png'
              alt='profile picture'
              fill
            />
          </article>
          <article className='profile-metadata mt-[1px] flex flex-col gap-[3px] items-center'>
            <article className='profile-metadata-name'>
              <h1 className='font-medium text-xl text-center text-neutral-900'>
                Sarah Dole
              </h1>
            </article>
            <article className='profile-metadata-designation'>
              <h2 className='font-normal text-sm text-center text-neutral-600'>
        ...
        <article className='profile-card_author_actions flex flex-col items-center gap-6 w-[100%]'>
          <button
            name='contact'
            className='btn btn--primary flex justify-center items-center px-3.5 rounded-s w-[100%] h-[44px] bg-[#4338ca] text-white'
          >
            Contact Me
          </button>
          <article className='flex gap-4 '>
            <a
              ...
              target='_blank'
              className='social-btn flex items-center justify-center rounded-s bg-[#4338ca] text-white'
            >
              <svg
                aria-hidden='true'
                width='20'
